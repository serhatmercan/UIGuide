...
*"     VALUE(IP_PARENT)     TYPE ZQMUI_S_USING_DECISION_TREE-PARENT OPTIONAL
*"     VALUE(IP_LEVEL)      TYPE ZQMUI_S_USING_DECISION_TREE-LEVEL OPTIONAL
*"  TABLES
*"      ET_USING_DECISION STRUCTURE  ZQMUI_S_USING_DECISION_TREE OPTIONAL
*"----------------------------------------------------------------------

  zcl_qmui_sh=>zcl_qmui_sh_usg_dec_tree( EXPORTING ip_codegruppe     = ip_codegruppe
                                                   ip_parent         = ip_parent
                                                   ip_level          = ip_level
                                         IMPORTING et_using_decision = et_using_decision ).
